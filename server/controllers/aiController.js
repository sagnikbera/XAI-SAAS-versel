...
export const generateImage = async (req, res) => {
  try {
    ...
    if (plan !== "freedom") {
      return res.json({
        success: false,
        message: "THis feature is only available to premium subscription.",
      });
    }

    //todo - https://clipdrop.co/apis/docs/text-to-image
      ...
      transformation: [
        {
          ...
          // Tells Cloudinary to apply background removal
