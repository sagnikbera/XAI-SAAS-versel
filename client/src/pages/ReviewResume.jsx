import { Captions, FileText, Sparkle } from "lucide-react";
    ...
    <div className="h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700">
      ...
      >
        <div className="flex items-center gap-3">
          <Sparkle className="w-6 text-[#0e7490]" />
        ...
        <button className="w-full flex justify-center items-center gap-2 bg-gradient-to-l to-[#083344] from-[#06b6d4] text-white px-4 py-2 mt-6 text-sm rounded-lg cursor-pointer">
